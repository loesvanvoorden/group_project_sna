...
# Create networks with raw weights
g_pre <- create_graph(edgelist_pre, all_parties, use_normalized = FALSE)
g_post <- create_graph(edgelist_post, all_parties, use_normalized = FALSE)
...
all_parties <- sort(ideology_data$party)
g_pre_viz <- create_graph(edgelist_pre, all_parties, use_normalized = FALSE)
g_post_viz <- create_graph(edgelist_post, all_parties, use_normalized = FALSE)
...
# Define party set for Study 2 (uses all parties, same as general analysis)
