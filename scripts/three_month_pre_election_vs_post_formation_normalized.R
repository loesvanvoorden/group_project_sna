# ============================================================================
# THREE MONTH PRE-ELECTION vs POST-FORMATION NETWORK ANALYSIS (Z-SCORE NORMALIZED)
...
cat("===============================================================================\n")
cat("THREE MONTH PRE-ELECTION vs POST-FORMATION NETWORK ANALYSIS (Z-SCORE NORMALIZED)\n")
...
pdf("results/visualizations/network_comparison_three_month_pre_vs_post_formation_normalized.pdf", width = 16, height = 8)
...
plot(g_pre,
     ...
     main = "PRE-ELECTION (3 MONTHS, Z-NORMALIZED)\n(Aug 22, 2023 - Nov 21, 2023)")
...
plot(g_post,
     ...
     vertex.label.family = "sans",
     vertex.frame.color = "white",
     main = "POST-FORMATION (3 MONTHS, Z-NORMALIZED)\n(Jul 5, 2024 - Oct 4, 2024)")
...
pdf("results/visualizations/detailed_three_month_pre_vs_post_formation_analysis_normalized.pdf", width = 16, height = 12)
...
pdf("results/visualizations/network_changes_three_month_pre_vs_post_formation_normalized.pdf", width = 16, height = 10)
...
barplot(t(metrics_matrix), beside = TRUE, col = c("#E74C3C", "#3498DB"),
        main = "Network Metrics Comparison (3 Months, Z-Normalized)",
        ylab = "Value", las = 2,
...
if(ecount(g_pre) > 0) {
  ...
  write.csv(edges_pre_df, "results/edge_lists/edges_three_month_pre_election_normalized.csv", row.names = FALSE)
}

if(ecount(g_post) > 0) {
  edges_post_df <- igraph::as_data_frame(g_post, "edges")
  write.csv(edges_post_df, "results/edge_lists/edges_three_month_post_formation_normalized.csv", row.names = FALSE)
}

# Export comparison statistics
write.csv(comparison_df, "results/statistics/three_month_pre_vs_post_formation_comparison_normalized.csv", row.names = FALSE)

cat("\n===============================================================================\n")
cat("ANALYSIS COMPLETE!\n")
cat("===============================================================================\n")
cat("Generated files:\n")
cat("  1. network_comparison_three_month_pre_vs_post_formation_normalized.pdf - Side-by-side comparison\n")
cat("  2. detailed_three_month_pre_vs_post_formation_analysis_normalized.pdf - Detailed network analysis\n")
cat("  3. network_changes_three_month_pre_vs_post_formation_normalized.pdf - Change metrics visualization\n")
cat("  4. edges_three_month_pre_election_normalized.csv - Edge list with z-scores (pre)\n")
cat("  5. edges_three_month_post_formation_normalized.csv - Edge list with z-scores (post)\n")
cat("  6. three_month_pre_vs_post_formation_comparison_normalized.csv - Statistical comparison\n")
cat("===============================================================================\n")
